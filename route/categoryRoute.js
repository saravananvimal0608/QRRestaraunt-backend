...
import { addCategory, getAllCategories, updateCategory, deleteCategory } from '../controller/categoryController.js'
...
// router.get("/:id", tempMiddleWare, adminMiddleware, getSingleCategory);
